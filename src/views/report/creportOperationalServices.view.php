<?php
  $title = "Report - Operational Services List - SBWMS";
    ...
    buttons: [
            {
                extend: 'print',
                footer: true,
                messageTop: '<img src="<?= url_for("assets/img/v2sriyani-motors-header.png"); ?>"><br><h2 class="text-center mt-2 mb-4">Service Types Report</h2>',
                title: ' ',
            }
        ],
    // columnDefs: [
