<?php
  $title = "Report - Service Duration List - SBWMS";
...
<body>
  <style>
    ...
    <div class="wrapper">
        <!-- sidebar start -->
        <?php
            $breadcrumbMarkUp = breadcrumbs(['Report' => '#', 'Service' => '#'], 'Service');
                  ...
                  <div class="col-md-12 mx-auto">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Average Service Duration</h4>
                      </div>
                      <div class="card-body">
                      <div class="">
                        <table id="top-customer-list" class="mx-auto">
                            ...
                            <tbody>
                              ...
                              <tr id="<?= $c['service_type_id']; ?>">
                                <td><?= $c['service_type_id']; ?></td>
                                <td><?= $c['name']; ?></td>
                                <td><?= $c['allocated_time']; ?></td>
                                <td><?= $c['average']; ?></td>
                                <td><?= $c['max']; ?></td>
                                <td><?= $c['min']; ?></td>
                              </tr>
                            ...
                            <!-- <tfoot>
                                <tr> -->
                                    <!-- <td></td> -->
                                    <!-- <td></td>
                                    <th scope="row">Service Count Total</th>
    ...
    buttons: [
            {
                extend: 'print',
                footer: true,
                messageTop: '<img src="<?= url_for("assets/img/v2sriyani-motors-header.png"); ?>"><br><h2 class="text-center mt-2 mb-4">Average Service Duration - December 2019</h2>',
                title: ' ',
            }
        ],
    // columnDefs: [
