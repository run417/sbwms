                  ...
                  <div class="col-md-12 mx-auto">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Service Count List</h4>
                      </div>
                      <div class="card-body">
                      <div class="">
    ...
    buttons: [
            {
                extend: 'print',
                footer: true,
                messageTop: '<img src="<?= url_for("assets/img/v2sriyani-motors-header.png"); ?>"><br><h3 class="text-center mt-2 mb-4">Service Count By Employee - December 2019</h3>',
                title: ' ',
            }
        ],
    // columnDefs: [
