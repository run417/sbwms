...
<body>
  ...
  <div class="wrapper">
    <!-- sidebar start -->
    <?php
    $breadcrumbMarkUp = breadcrumbs(['Service Order' => '#', 'On-hold' => '#'], 'On-hold');
    require_once(COMMON_VIEWS . 'sidebar.php');
    ?>
    <span id="active_menu" data-menu="service-order"></span>
    <span id="sub_menu" data-submenu="on-hold"></span>
    <!-- sidebar end -->
            ...
            <div class="col-md-9 mx-auto">
              <div class="card animated fadeIn">
                <div class="card-header">
                  <h4 class="card-title">On-hold Services List</h4>
                  <!-- <a href="#" id="new_booking" class="btn btn-primary btn-lg">Book Service</a> -->
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="on-hold-service-order-table" class="table table-hover">
                      <thead>
  ...
  <script src="<?= url_for('/assets/js/custom/service-order/list-on-hold.js') ?>"></script>
  <script>
