                  ...
                  <div class="col-md-9 mx-auto">
                    ...
                    <div class="card animated fadeIn">
                      <div class="card-header">
                        ...
                        <a href="#" id="start-service-btn" class="btn btn-outline-success">Start Service</a>
                      </div>
                      <div class="card-body">
                      ...
                      <!-- box -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-body d-flex justify-content-around">
                                <span class="dd"><span class="dt">Vehicle: </span><?php echo $v->getVehicleId(); echo ' - ' . $v->getMakeModelYear(); ?><button class="ml-2 btn btn-outline-primary btn-sm">View Service History</button></span>
                                <span class="dd"><span class="dt">Customer: </span><?php echo $c->getCustomerId(); echo ' - ' . $c->getFullName(); ?></span>
                            </div>
                            <div class="box-body d-flex justify-content-around">
                            ...
                            <div class="box-body d-flex justify-content-around">
                                <span class="dd"><span class="dt">Employee</span><?php echo $e->getEmployeeId(); echo ' - ' . $e->getFirstName(); ?></span>
                                <span class="dd"><span class="dt">Service </span><?php echo $st->getId(); echo ' - ' . $st->getName(); ?></span>
                            </div>
                        </div>
                      ...
                      <div class="card-footer">
                        <!-- <bu tton id="complete-service-btn" class="btn btn-success">Complete Service</button> -->
                      </div> <!-- </.card-footer> -->
                    </div> <!-- </.card> -->
                  </div> <!-- </.col> -->
                </div> <!-- </.row> -->
