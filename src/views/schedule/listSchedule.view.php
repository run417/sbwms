                                                ...
                                                <tbody>
                                                    <?php foreach ($bookings as $s) : ?>
                                                        <tr id="<?= $s->getId(); ?>">
                                                            ...
                                                            <td><a class="viewBooking" href="<?= url_for('/booking/view?id=') . $s->getBookingId(); ?>"><i class="far fa-list-alt" data-toggle="tooltip" data-placement="top" title="View Booking"></i></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
